...
document.addEventListener("DOMContentLoaded", function () {
  ...
  selectedFeatures.on(["add", "remove"], function () {
    const names = selectedFeatures.getArray().map(function (feature) {
      ...
      const record_rate_city_touch =
        feature.get("record_rate_city_touch") || "";
      ...
      const record_rate_bojunmount =
        feature.get("record_rate_bojunmount") || "";
      ...
      return {
        ...
        record_height,
        record_dist_gi_str,
        record_dist_gong_ntwk,
        record_rate_city,
        record_rate_city_touch,
        record_dist_road,
        record_rate_kyungji,
        record_rate_saengtae,
        record_rate_gongjuck,
        record_dist_gongjuck,
        record_rate_jdgarea,
        record_rate_nongup,
        record_rate_limsangdo,
        record_rate_bojunmount,
        record_dist_kyungji,
        value_develop,
        value_conserv,
        value_comp,
  ...
  function updateComboBox(features) {
    ...
    features.forEach(function (feature) {
      if (feature.jibun) {
        ...
        option.setAttribute(
          "record_rate_saengtae",
          feature.record_rate_saengtae
        );
        option.setAttribute(
          "record_rate_gongjuck",
          feature.record_rate_gongjuck
        );
        option.setAttribute(
          "record_dist_gongjuck",
          feature.record_dist_gongjuck
        );
        ...
        option.setAttribute(
          "record_rate_limsangdo",
          feature.record_rate_limsangdo
        );
        option.setAttribute(
          "record_rate_bojunmount",
          feature.record_rate_bojunmount
        );
  ...
  comboBox.addEventListener("change", function () {
    ...
    click_F_tpgrph_hg_code_nm =
      selectedOption.getAttribute("tpgrph_hg_code_nm"); // 경사도
    ...
    click_F_road_side_code_nm =
      selectedOption.getAttribute("road_side_code_nm"); // 도로인접여부
    ...
    click_F_record_dist_gi_str =
      selectedOption.getAttribute("record_dist_gi_str");
    click_F_record_dist_gong_ntwk = selectedOption.getAttribute(
      "record_dist_gong_ntwk"
    );
    click_F_record_rate_city = selectedOption.getAttribute("record_rate_city");
    click_F_record_rate_city_touch = selectedOption.getAttribute(
      "record_rate_city_touch"
    );
    click_F_record_dist_road = selectedOption.getAttribute("record_dist_road");
    click_F_record_rate_kyungji = selectedOption.getAttribute(
      "record_rate_kyungji"
    );
    click_F_record_rate_saengtae = selectedOption.getAttribute(
      "record_rate_saengtae"
    );
    click_F_record_rate_gongjuck = selectedOption.getAttribute(
      "record_rate_gongjuck"
    );
    click_F_record_dist_gongjuck = selectedOption.getAttribute(
      "record_dist_gongjuck"
    );
    click_F_record_rate_jdgarea = selectedOption.getAttribute(
      "record_rate_jdgarea"
    );
    click_F_record_rate_nongup =
      selectedOption.getAttribute("record_rate_nongup");
    click_F_record_rate_limsangdo = selectedOption.getAttribute(
      "record_rate_limsangdo"
    );
    click_F_record_rate_bojunmount = selectedOption.getAttribute(
      "record_rate_bojunmount"
    );
    click_F_record_dist_kyungji = selectedOption.getAttribute(
      "record_dist_kyungji"
    );
  ...
  function fetchDataAndDisplay() {
    ...
    if (inserted_record_slope[click_F_pnu] === undefined) {
      // 수정값이 없는 경우 - 즉, 처음 조회하는 경우
      ...
      document.getElementById("aaaa01").value =
        inserted_record_slope[click_F_pnu];
      document.getElementById("aaaa02").value =
        inserted_record_height[click_F_pnu];
      document.getElementById("aaaa03").value =
        inserted_record_dist_gi_str[click_F_pnu];
      document.getElementById("aaaa04").value =
        inserted_record_dist_gong_ntwk[click_F_pnu];
      document.getElementById("bbbb01").value =
        inserted_record_rate_city[click_F_pnu];
      document.getElementById("bbbb02").value =
        inserted_record_rate_city_touch[click_F_pnu];
      document.getElementById("bbbb03").value =
        inserted_record_dist_road[click_F_pnu];
      document.getElementById("cccc01").value =
        inserted_record_rate_kyungji[click_F_pnu];
      document.getElementById("cccc02").value =
        inserted_record_rate_saengtae[click_F_pnu];
      document.getElementById("cccc03").value =
        inserted_record_rate_gongjuck[click_F_pnu];
      document.getElementById("cccc04").value =
        inserted_record_dist_gongjuck[click_F_pnu];
      document.getElementById("dddd01").value =
        inserted_record_rate_jdgarea[click_F_pnu];
      document.getElementById("dddd02").value =
        inserted_record_rate_nongup[click_F_pnu];
      document.getElementById("dddd03").value =
        inserted_record_rate_limsangdo[click_F_pnu];
      document.getElementById("dddd04").value =
        inserted_record_rate_bojunmount[click_F_pnu];
      document.getElementById("dddd05").value =
        inserted_record_dist_kyungji[click_F_pnu];
      document.getElementById("input2").value =
        inserted_value_develop[click_F_pnu];
      document.getElementById("input3").value =
        inserted_value_conserv[click_F_pnu];
      document.getElementById("input4").value =
        inserted_value_comp[click_F_pnu];
    }
  ...
  document.getElementById("insertData").onclick = () => {
    ...
    localStorage.setItem(
      "inserted_tpgrph_hg_code_nm",
      JSON.stringify(inserted_tpgrph_hg_code_nm)
    );
    localStorage.setItem(
    ...
    localStorage.setItem(
      "inserted_record_height",
      JSON.stringify(inserted_record_height)
    );
    localStorage.setItem(
      "inserted_record_dist_gi_str",
      JSON.stringify(inserted_record_dist_gi_str)
    );
    localStorage.setItem(
      "inserted_record_dist_gong_ntwk",
      JSON.stringify(inserted_record_dist_gong_ntwk)
    );
    localStorage.setItem(
      "inserted_record_rate_city",
      JSON.stringify(inserted_record_rate_city)
    );
    localStorage.setItem(
      "inserted_record_rate_city_touch",
      JSON.stringify(inserted_record_rate_city_touch)
    );
    localStorage.setItem(
      "inserted_record_dist_road",
      JSON.stringify(inserted_record_dist_road)
    );
    localStorage.setItem(
      "inserted_record_rate_kyungji",
      JSON.stringify(inserted_record_rate_kyungji)
    );
    localStorage.setItem(
      "inserted_record_rate_saengtae",
      JSON.stringify(inserted_record_rate_saengtae)
    );
    localStorage.setItem(
      "inserted_record_rate_gongjuck",
      JSON.stringify(inserted_record_rate_gongjuck)
    );
    localStorage.setItem(
      "inserted_record_dist_gongjuck",
      JSON.stringify(inserted_record_dist_gongjuck)
    );
    localStorage.setItem(
      "inserted_record_rate_jdgarea",
      JSON.stringify(inserted_record_rate_jdgarea)
    );
    localStorage.setItem(
      "inserted_record_rate_nongup",
      JSON.stringify(inserted_record_rate_nongup)
    );
    localStorage.setItem(
      "inserted_record_rate_limsangdo",
      JSON.stringify(inserted_record_rate_limsangdo)
    );
    localStorage.setItem(
      "inserted_record_rate_bojunmount",
      JSON.stringify(inserted_record_rate_bojunmount)
    );
    localStorage.setItem(
      "inserted_record_dist_kyungji",
      JSON.stringify(inserted_record_dist_kyungji)
    );
    localStorage.setItem(
      "inserted_value_develop",
      JSON.stringify(inserted_value_develop)
    );
    localStorage.setItem(
      "inserted_value_conserv",
      JSON.stringify(inserted_value_conserv)
    );
    localStorage.setItem(
      "inserted_value_comp",
      JSON.stringify(inserted_value_comp)
    );
  ...
  function sendData(
    ...
    var url = `./fetchData.jsp?selected_pnu=${encodeURIComponent(
      click_F_pnu
    )}&inserted_record_slope=${encodeURIComponent(
      inserted_record_slope
    )}&inserted_record_height=${encodeURIComponent(
      inserted_record_height
    )}&inserted_record_dist_gi_str=${encodeURIComponent(
      inserted_record_dist_gi_str
    )}&inserted_record_dist_gong_ntwk=${encodeURIComponent(
      inserted_record_dist_gong_ntwk
    )}&inserted_record_rate_city=${encodeURIComponent(
      inserted_record_rate_city
    )}&inserted_record_rate_city_touch=${encodeURIComponent(
      inserted_record_rate_city_touch
    )}&inserted_record_dist_road=${encodeURIComponent(
      inserted_record_dist_road
    )}&inserted_record_rate_kyungji=${encodeURIComponent(
      inserted_record_rate_kyungji
    )}&inserted_record_rate_saengtae=${encodeURIComponent(
      inserted_record_rate_saengtae
    )}&inserted_record_rate_gongjuck=${encodeURIComponent(
      inserted_record_rate_gongjuck
    )}&inserted_record_dist_gongjuck=${encodeURIComponent(
      inserted_record_dist_gongjuck
    )}&inserted_record_rate_jdgarea=${encodeURIComponent(
      inserted_record_rate_jdgarea
    )}&inserted_record_rate_nongup=${encodeURIComponent(
      inserted_record_rate_nongup
    )}&inserted_record_rate_limsangdo=${encodeURIComponent(
      inserted_record_rate_limsangdo
    )}&inserted_record_rate_bojunmount=${encodeURIComponent(
      inserted_record_rate_bojunmount
    )}&inserted_record_dist_kyungji=${encodeURIComponent(
      inserted_record_dist_kyungji
    )}&inserted_value_develop=${encodeURIComponent(
      inserted_value_develop
    )}&inserted_value_conserv=${encodeURIComponent(
      inserted_value_conserv
    )}&inserted_value_comp=${encodeURIComponent(inserted_value_comp)}`;
    fetch(url, {
  ...
  function calculateDevVal() {
    ...
    // 선택된 선택지표 값 가져오기
    const selectedDevCheckboxes = document.querySelectorAll(
  ...
  function calculateConVal() {
    ...
    // 선택된 선택지표 값 가져오기
    const selectedConCheckboxes = document.querySelectorAll(
      ".con-checkbox:checked"
    );
  ...
  function deleteData(click_F_pnu) {
    ...
    var url = `./deleteData.jsp?selected_pnu=${encodeURIComponent(
      click_F_pnu
    )}`;
    fetch(url, {
      method: "POST",
