...
document.addEventListener("DOMContentLoaded", function () {
  ...
  selectedFeatures.on(["add", "remove"], function () {
    const names = selectedFeatures.getArray().map(function (feature) {
      ...
      return { jibun, a1, a11, a12, a14, a20, a22, a24, slope, height, dist_gi_str, dist_gong_ntwk, record_slope };
    });
  ...
  function sendData(clickedFeatureA1, inserted_record_slope) {
    var url =
      `./fetchData.jsp?selectedA1=${encodeURIComponent(clickedFeatureA1)}&inserted_record_slope=${encodeURIComponent(inserted_record_slope)}`;
    fetch(url, {
